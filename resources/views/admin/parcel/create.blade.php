                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('admin.parcel.store')}}" method="POST" class="">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control bSelect" name="weight_range_id" id="weight_range_id" class="form-control" v-model="weight_range_id" @change="fetch_delivey_cod" required>
                                                    ...
                                                    @foreach($weight_ranges as $weight_range)
                                                        <option value="{{ $weight_range->id }}">{{ $weight_range->min_weight }} - {{ $weight_range->max_weight }}  ( Code={{$weight_range->code}} )</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
                                            <div class="form-group">
                                                <label for="customer_another_mobile">Customer Other Mobile Number</label>
                                                <!-- <input type="text" class="form-control" id="customer_another_mobile" name="customer_another_mobile" placeholder="Enter Other Customer Mobile"> -->
                                                <div class="input-group mb-2">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" id="basic-addon1">+88</span>
                                                    </div>
                                                    <input type="text" class="form-control" id="customer_another_mobile" name="customer_another_mobile" placeholder="Enter Other Customer Mobile" aria-label="Username" aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                        </div>
