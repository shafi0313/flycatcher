                ...
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <div class="d-none d-lg-flex align-items-center p-5 col-lg-8">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('app-assets\images\banner\rider.png') }}" alt="Login V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Login-->
                        <div class="d-flex align-items-center auth-bg px-2 p-lg-5 col-lg-4">
                            <div class="px-xl-2 mx-auto col-sm-8 col-md-10 col-lg-12">
                                ...
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    <h1 class="card-title font-weight-bold mb-1" style="text-align: center;  text-decoration: underline;"><b>Rider Login</b></h1>
                                    ...
                                    <form class="auth-login-form mt-2" action="{{ route('rider.loginCheck') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between">
                                                <label for="login-password">Password</label><a href="{{route('rider.password.request')}}"><small>Forgot Password?</small></a>
                                            </div>
